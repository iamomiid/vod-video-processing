...
-vn -acodec aac -ab 256k -hls_time 1 -hls_key_info_file key.info -hls_playlist_type vod -hls_segment_filename hls/audio/fileSequence%d.ts hls/audio/stream.m3u8
cp master.m3u8 hls